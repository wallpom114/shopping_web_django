...
SECRET_KEY = 'django-insecure-gq25k3a1nnanago#dnec1+q&!5%7^8@$mehk6#0d&m13_xvrsl'
...
STATIC_URL = '/static/'
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'admin_page/static'),
]
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'hoangdeptrai1404@gmail.com'  # Thay bằng email của bạn
